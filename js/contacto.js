...
function init() {
    ...
    btnEnviar.onclick = function() {
        ...
        if (nombre === '' && apellido === '' && email === '' && numero === '' && mensaje === '') {
            ...
            emailjs.sendForm('service_6qk362b', 'template_z42jas7', '#form1', 'AAoFUA_QhvnDBKIhP'); //1er es serivce ID (email sevices) | 2do es -> setting -> template (email templates)| 4to es account
